...
const StatusToggle: React.FC<StatusToggleProps> = ({
  ...
  const { mergeMode: internalMergeMode, activeState, toggleViewMode, setMergeMode: internalSetMergeMode, isHovering, handleMouseEnter, handleMouseLeave } = useButtonModes();
