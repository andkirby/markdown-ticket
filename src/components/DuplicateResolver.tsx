...
export const DuplicateResolver: React.FC<DuplicateResolverProps> = ({ projectId, onResolved }) => {
  ...
  if (loading)
    return <div>Checking for duplicates...</div>
  if (duplicates.length === 0)
    return null

  return (
    <div
      className="duplicate-resolver"
      style={{
        position: 'fixed',
        top: 0,
        left: 0,
    ...
    >
      ...
      >
        ...
        >
          <strong>💡 How renaming works:</strong>
          <br />
      ...
      {showConfirm && (
        ...
        >
          ...
          >
            <h3>
              Confirm
              {showConfirm.action === 'rename' ? 'Rename' : 'Delete'}
            </h3>
            <p>
              ...
              >
                ...
                <div style={{ fontSize: '13px', fontFamily: 'monospace' }}>
                  <div style={{ color: '#28a745' }}>
                    ✓ New ticket key:
                    {' '}
                    <strong>{showConfirm.preview.newCode}</strong>
                  </div>
                  <div style={{ color: '#28a745' }}>
                    ✓ New filename:
                    {' '}
                    <strong>{showConfirm.preview.newFilename}</strong>
                  </div>
                </div>
              </div>
            )}
