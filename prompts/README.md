...
- **Integration**: Uses `mcp__mdt-all__create_cr` and related tools
...
- **Integration**: Uses `mcp__mdt-all__get_cr` and `mcp__mdt-all__manage_cr_sections`
...
- **Integration**: Uses `mcp__mdt-all__manage_cr_sections` for surgical updates
