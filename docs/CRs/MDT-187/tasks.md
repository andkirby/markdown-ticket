...
- [x] 1. Add Popover primitive (`TASK-popover`)
  Owns: `frontend/src/components/ui/popover.tsx`, `@radix-ui/react-popover` dependency
...
- [x] 2. Add elision helper + tests (`TASK-elide`)
  Owns: `frontend/src/components/Badge/relationshipLink.ts`, `frontend/src/components/Badge/relationshipLink.test.ts`
...
- [x] 3. Update RelationshipBadge: displayMode + elision + per-link title (`TASK-compact`)
  Owns: `frontend/src/components/Badge/RelationshipBadge.tsx` (elision path)
...
- [x] 4. Add overflow trigger + popover to RelationshipBadge (`TASK-overflow`)
  Owns: `frontend/src/components/Badge/RelationshipBadge.tsx` (overflow path)
...
- [x] 5. Wire board to compact mode (`TASK-wire-board`)
  Owns: `frontend/src/components/TicketAttributeTags.tsx`
...
- [x] 6. Update RelationshipBadge tests for new contract (`TASK-tests`)
  Owns: `frontend/src/components/Badge/RelationshipBadge.test.tsx`
...
- [x] 7. Verify gates (`TASK-verify`)
  Owns: —
  Makes Green: `bun run validate:ts` (changed files), `bun run lint:all`, `bun test --isolate ./frontend/src/components/Badge`
...
|---|---|
| `frontend/src/components/ui/popover.tsx` | TASK-popover |
| `@radix-ui/react-popover` | TASK-popover |
| `frontend/src/components/Badge/relationshipLink.ts` | TASK-elide |
| `frontend/src/components/Badge/relationshipLink.test.ts` | TASK-elide |
| `frontend/src/components/Badge/RelationshipBadge.tsx` (elision) | TASK-compact |
| `frontend/src/components/Badge/RelationshipBadge.tsx` (overflow) | TASK-overflow |
| `frontend/src/components/TicketAttributeTags.tsx` | TASK-wire-board |
| `frontend/src/components/Badge/RelationshipBadge.test.tsx` | TASK-tests |
