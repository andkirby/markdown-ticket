...
- [ ] Verify generated share and invite links use the runtime-configured `PUBLIC_ORIGIN` and do not fall back to `localhost`.
- [ ] Add E2E coverage for the owner journey where a configured public origin is used for a read-access invite link.
