...
- Display active project as larger card containing code and title with favorite indicator; clicking opens browser panel (`OBL-active-project-card-display`)
  Derived From: `BR-1.1`, `BR-1.2`, `BR-3.1`
  Artifacts: `ART-selector-card`, `ART-selector-rail`, `ART-selector-index`, `ART-browser-panel`, `ART-selector-types`
- Active project card click opens full project browser panel (`OBL-active-project-click-opens-browser`)
  Derived From: `BR-3.1`
  Artifacts: `ART-selector-rail`, `ART-browser-panel`, `ART-selector-index`
...
- Display hover card with full project details on inactive chip hover (`OBL-hover-card-on-chips`)
  Derived From: `BR-3.2`, `BR-3.3`, `BR-3.4`
  Artifacts: `ART-selector-chip`, `ART-selector-card`, `ART-hover-card-component`
- Render inactive visible rail projects as compact chips (`OBL-inactive-projects-display-mode`)
  Derived From: `BR-2.1`, `BR-2.3`
...
- On mobile viewport, display only active project card; clicking it provides access to remaining projects (`OBL-responsive-collapse`)
  Derived From: `BR-9.1`, `BR-9.3`
...
| `BR-3.1` | 3 | `OBL-active-project-card-display`, `OBL-active-project-click-opens-browser`, `OBL-test-coverage` |
| `BR-3.2` | 2 | `OBL-hover-card-on-chips`, `OBL-test-coverage` |
| `BR-3.3` | 2 | `OBL-hover-card-on-chips`, `OBL-test-coverage` |
| `BR-3.4` | 2 | `OBL-hover-card-on-chips`, `OBL-test-coverage` |
...
| `C5` | 1 | `OBL-test-coverage` |
| `C6` | 2 | `OBL-configuration-load-and-defaults`, `OBL-test-coverage` |
| `C7` | 2 | `OBL-active-project-always-visible`, `OBL-test-coverage` |
| `C9` | 2 | `OBL-panel-displays-full-list`, `OBL-test-coverage` |
| `C10` | 4 | `OBL-configuration-load-and-defaults`, `OBL-load-selector-data`, `OBL-state-persistence`, `OBL-test-coverage` |
