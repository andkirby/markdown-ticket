...
- Badge variants color mappings (`TEST-badge-variants`)
  ...
  File: `frontend/src/components/Badge/badgeVariants.test.ts`
- ContextBadge component tests (`TEST-context-badge`)
  Covers: `BR-8`
  File: `frontend/src/components/Badge/ContextBadge.test.tsx`
- No duplicate color functions remain (`TEST-no-duplicate-funcs`)
  Covers: `C4`
- PriorityBadge component tests (`TEST-priority-badge`)
  Covers: `BR-4`, `BR-6`
  File: `frontend/src/components/Badge/PriorityBadge.test.tsx`
...
- StatusBadge component tests (`TEST-status-badge`)
  ...
  File: `frontend/src/components/Badge/StatusBadge.test.tsx`
- TypeBadge component tests (`TEST-type-badge`)
  Covers: `BR-5`, `BR-7`
  File: `frontend/src/components/Badge/TypeBadge.test.tsx`
