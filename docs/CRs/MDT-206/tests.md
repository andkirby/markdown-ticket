...
| `tests/e2e/board/swimlane-board.spec.ts` | `3 failed`: missing `board-mode-epics-toggle`; later failed for childless Proposed epic lane omission | `5 passed` |
...
- E2E tests cover mode switching, persistence, lane rendering, childless epic lanes, epic-card exclusion in flat/swimlane modes, same-epic drag, cross-epic rejection, progress, blocked close tooltips, and collapse/expand controls.
