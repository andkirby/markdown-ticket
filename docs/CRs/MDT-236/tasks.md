...
**Structure**: `src/styles/design-tokens.css`
...
**Modifies**: `src/styles/design-tokens.css`
...
**Structure**: `src/components/ui/table.tsx`
...
**Modifies**: `src/components/ui/table.tsx`
...
**Structure**: `src/components/DocumentsView/documents-view.css`
...
**Modifies**: `src/components/DocumentsView/documents-view.css`
...
**Structure**: `src/components/QuickSearch/quick-search.css`, `src/components/ProjectSelector/project-selector.css`, `src/components/TicketAttributes.tsx`
...
**Structure**: `src/components/TicketCard/ticket.css` + all content text consuming `--fs-xs`
...
**Modifies**: `src/components/TicketCard/ticket.css`, `src/components/PinRail/pin-rail.css`
**Verify**:
```bash
...
**Structure**: `src/THEME.md`, `src/styleguide.html`
...
bun run check
rg -n "font-size:\s*[\d.]+(px|rem)" src/components/QuickSearch src/components/ProjectSelector src/components/DocumentsView src/components/ui/table.tsx   # expect: no hits
```
