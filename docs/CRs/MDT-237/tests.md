...
| File | Kind | Covers |
|------|------|--------|
| `src/utils/markdownPreprocessor.mdt237.test.ts` | unit (bun test) | BR-1.1, BR-2.2, BR-3.1, BR-3.2, BR-4.1, C1, C2, C4, Edge-1 |
| `src/utils/documentExistenceCache.test.ts` | unit (bun test) | BR-2.1, C5 |
...
`bun test ./src/utils/markdownPreprocessor.mdt237.test.ts ./src/utils/documentExistenceCache.test.ts`
...
- Unit: `bun test ./src/utils/markdownPreprocessor.mdt237.test.ts ./src/utils/documentExistenceCache.test.ts`
