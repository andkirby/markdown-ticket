...
**Structure**: `src/utils/documentExistenceCache.ts`

**Makes GREEN (Automated Tests)**:
- `TEST-unit-cache` → `src/utils/documentExistenceCache.test.ts`
...
**Creates**: `src/utils/documentExistenceCache.ts`
**Modifies**: None
...
**Makes GREEN (Automated Tests)**:
- `TEST-unit-conversion`, `TEST-unit-preservation` → `src/utils/markdownPreprocessor.mdt237.test.ts`
...
**Modifies**: `src/utils/markdownPreprocessor.ts`
**Must Not Touch**: `src/routes.ts`, `linkProcessor.ts`, `linkNormalization.ts`
...
**Structure**: `src/components/SmartLink/index.tsx`
...
**Modifies**: `src/components/SmartLink/index.tsx`
