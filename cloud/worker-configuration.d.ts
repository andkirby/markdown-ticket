/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5084acf6103545fbe1c73327b387dd01)
...
interface __BaseEnv_Env {
	...
	PROJECT_HUB: DurableObjectNamespace<import("./src/cloudflare/worker").ProjectProjectionHub>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/cloudflare/worker");
		durableNamespaces: "ProjectProjectionHub";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TEAM_DOMAIN" | "COORDINATION_AUD" | "OPERATOR_AUD">> {}
}
