...
import { ValidationResult, ValidationError, ValidationWarning, TestCRData, ProjectCodeRegex } from '../types/project-factory-types';
...
export class ValidationRules {
  ...
  static sanitizeProjectCode(projectCode: string): string {
    return projectCode ? projectCode.replace(/[^a-zA-Z]/g, '').toUpperCase().substring(0, 10) : projectCode;
  }
