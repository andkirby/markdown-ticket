...
describe('mCP Tools Service Delegation Tests', () => {
  ...
  describe('service Isolation', () => {
    it('should maintain clear service boundaries', () => {
      ...
      Object.entries(serviceResponsibilities).forEach(([_service, responsibilities]) => {
    ...
    it('should use dependency injection correctly', () => {
      ...
      Object.entries(injectionPattern).forEach(([_handler, dependencies]) => {
  ...
  describe('error Handling', () => {
    ...
    it('should handle service unavailability gracefully', () => {
      ...
      Object.entries(errorScenarios).forEach(([_service, errors]) => {
